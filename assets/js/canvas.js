(function() {
  ...
  rt = animation.parentNode.getBoundingClientRect();
  var w = animation.width = rt.width,
      h = animation.height = rt.height,
  ...
  window.addEventListener( 'resize', function(){
    rt = animation.parentNode.getBoundingClientRect();
    opts.vanishPoint.x = ( w = animation.width = rt.width ) / 2;
    opts.vanishPoint.y = ( h = animation.height = rt.height ) / 2;
    ctx.clearRect( 0, 0, w, h );
  });
